    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
                ...
                <input type="hidden" name="device_id" id="device_id" class="form-control"  value='<?php echo $vhid;?>'/>
	        		<input type="text" name="user_name" id="user_name" class="form-control" placeholder="Enter Your Name" value='<?php echo $email;?>'readonly />
	        	</div>
	        	<div class="form-group">
    ...
    $('#save_review').click(function(){
        ...
        else
        {
            $.ajax({
                ...
                method:"POST",
                data:{rating_data:rating_data, device_id:device_id, user_name:user_name, user_review:user_review},
